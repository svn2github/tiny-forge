 ...
 *  6.0 - Extend the default WordPress body classes.
...
function tinyforge_add_meta_to_head () {
	...
	// echo "\n"; echo '<!-- Find out who built this website! Read humans.txt for more information. -->'; echo "\n"; echo '<link rel="author" type="text/plain" href="'.get_template_directory_uri().'/humans.txt" />'; echo "\n";
 ...
 * 6.0 - Extend the default WordPress body classes.
 *
 * Extend the default WordPress body class to denote:
