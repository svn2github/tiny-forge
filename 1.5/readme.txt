...
- Tip62 - Add side borders for the middle footer widget - to better separate widgets visually (style.css)
...
- Bug fix: corrected the parent theme template name in the child theme example: Template: tiny-forge. Thanks to David Radovanovic for the tip ( http://wordpress.org/support/profile/dpaule ).- Enhancement: added Tip62 - Add side borders for the middle footer widget - to better separate widgets visually.
