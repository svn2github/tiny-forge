...
It's all there, you have everything in one neat package. Tiny Forge can be used as a learning tool or your own little web development "framework". 
...
Tiny Forge v1.2.2-3 (2013-09-05)
----------------------------

- Optimized header image.
- Removed unnecessary comments.
- Fixed .entry-title size
...
- Non-existing HTML5 element hgroup replaced with div.site-branding (taken from _s) (header.php).
...
- Theme evaluation, suggestions for improvement:
	...
	- Zulfikar Nore (ZGani) http://wpstrapcode.com , http://profiles.wordpress.org/ZGani
