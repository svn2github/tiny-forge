...
function tinyforge_setup() {
	...
	// 3.8 - This theme uses a custom image size for featured images, displayed on "standard" posts. See http://wordpress.stackexchange.com/questions/108572/set-post-thumbnail-size-vs-add-image-size
...
function tinyforge_scripts_styles() {
	...
	*/
	...
	// wp_enqueue_style( 'tinyforge-style', get_stylesheet_uri(), array( 'tinyforge-google-fonts' ) );
...
// 12.7 - Tip84 - Remove error message on the login page - better for security reasons, via: http://www.wpbeginner.com/wp-tutorials/11-vital-tips-and-hacks-to-protect-your-wordpress-admin-area/
