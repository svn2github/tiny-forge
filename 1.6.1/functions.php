 ...
 *    3.9b - Let WordPress manage the document title.
...
function tinyforge_setup() {
	...
	/* 3.9b - Let WordPress manage the document title. Also see /inc/back-compat.php.
	 *
...
function tinyforge_get_font_url() {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'tinyforge' ) ) {
		...
		$font_url = esc_url( add_query_arg( $query_args, "$protocol://fonts.googleapis.com/css" ) );
	}
