	...
	<section id="primary" class="site-content">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title" itemprop="headline"><span class="icon-webfont icon-search"></span> <?php printf( __( 'Search Results for: %s', 'tinyforge' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
			</header>
