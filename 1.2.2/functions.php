...
function tinyforge_entry_meta() {
	...
	if ( $tag_list ) {
		$utility_text = __( 'Posted on %3$s<span class="by-author"> by %4$s</span> in %1$s and tagged %2$s.', 'twentytwelve' );
	} elseif ( $categories_list ) {
		$utility_text = __( 'Posted on %3$s<span class="by-author"> by %4$s</span> in %1$s.', 'twentytwelve' );
	} else {
