...
(plus forth footer widget to insert your copyright information), icon webfont support from Twenty Thirteen and Schema.org microdata format support.
...
- Custom headers for posts and pages - ported from Twenty Eleven
...
http://wordpress.org/support/topic/showcase-your-tiny-forge-site-or-mod
...
3. If you want to use icon webfont for social networks (as you can see in the screenshot), use standard text widget in the Main Sidebar Widget 
...
4. Go to Theme Customizer (Admin Panel Menu > Appearance > Customize) and see if you need to change any visual aspects of your site.
...
3. If you want to have a rotating header images, upload several images (Admin Panel Menu > Appearance > Header > Select Image) and then select "Random: Show a different image on each page."

4. In case you need to display an image without any borders or shadows, include "no-border" class for the desired post image.

5. If your'e posting code in the post, first it should be escaped (use: http://www.elliotswan.com/postable/), then wrap it in <code> for inline usage and <pre><code> for blocks of code.

6. Don't know how to use LESS dynamic stylesheet language? Start reading here:	http://webdesign.tutsplus.com/tutorials/htmlcss-tutorials/get-into-less-the-programmable-stylesheet-language/
...
- Enhancement: updated tinyforge.pot file for better localization.
- Enhancement: added French translation - BIG thanks to Dolordo - http://wordpress.org/support/profile/dolordo
