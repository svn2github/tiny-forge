 ...
 *    5.6 - Filter TinyMCE CSS path to include Google Fonts. Add additional stylesheets to the TinyMCE editor if needed.
...
/**
 * 5.6 - Filter TinyMCE CSS path to include Google Fonts.
 *
